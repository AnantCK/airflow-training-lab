...
2. ระบบจะเปิดแท็บใหม่เข้าสู่หน้า Airflow Login
3. กรอก Username: `airflow` และ Password: `airflow` เพื่อเริ่มใช้งานและแก้ไขโค้ดในโฟลเดอร์ `dags/` ได้ทันที
4. หากขึ้น error ให้รอระบบสำหรับการเปิดใช้งานประมาณ 1-2 นาทีเนื่องจากต้องใช้เวลาในช่วนเริ่มใช้งานครั้งแรก